...
/**
 * Indicates that an annotated class represents a "Repository" as defined by
...
public @interface DddRepository {
     ...
     * {@code @DddRepository("A meaningful name")} instead of
     * {@code @DddRepository(name="A meaningful name")}. Only one of these
    ...
    /**
     * Additional information that is related to the Repository
     * <p>
